          ...
          <div class="card mt-1 mb-3">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-4">
                  <input type="text" class="form-control" id="buyerName" name="buyerName" placeholder="Enter your name" value="${user.userName}"
                    required>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input type="email" class="form-control" id="buyerEmail" name="buyerEmail"
                    aria-describedby="emailHelp" placeholder="Enter your email" value="${user.userEmail}" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="phone" class="col-md-2 col-form-label">핸드폰 번호</label>
                <div class="col-md-6">
                  <input type="tel" class="form-control" id="buyerPhone" name="buyerPhone" placeholder="Enter your cell phone number" value="${user.phone}" required>
          ...
          <div class="card mt-1 mb-2">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="주소 찾기 버튼을 눌러 입력" value="${user.zipcode}"
                      readonly>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="form-group row">
                  <label for="phone" class="col-md-2 col-form-label">핸드폰 번호</label>
                  <div class="col-md-6">
                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter your cell phone number" value="${user.phone}" required>
                    <small class="form-text text-muted">예) 010-1234-4567</small>
                  </div>
                </div>
