      ...
      >
        <ul class="navbar-nav" style="margin-left: 40%">
          <li class="nav-item">
            <a
              class="nav-link"
              href="${pageContext.request.contextPath}/navlink1"
              >Link</a
            >
          </li>
          <li class="nav-item">
            <a
              class="nav-link"
              href="${pageContext.request.contextPath}/navlink2"
              >Link</a
            >
          </li>
          <li class="nav-item">
            <a
              class="nav-link"
              href="${pageContext.request.contextPath}/navlink3"
              >Link</a
            >
          </li>
        </ul>
                          ...
                          <c:when test="${authInfo.roles eq 'admin' }">
                            ...
                            <div class="dropdown">
                              ...
                              >
                                ...
                                <a
                                  class="dropdown-item"
                                  href="${pageContext.request.contextPath}/users/modifyuser"
                                  >회원정보수정</a
                                >
                                <a
                                  class="dropdown-item"
                                  href="${pageContext.request.contextPath}/users/preunregister"
                                  >회원탈퇴</a
                                >
                              </div>
                            </div>
