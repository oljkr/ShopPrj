          ...
          <div class="collapse navbar-collapse justify-content-between" id="collapsibleNavbar">
            <ul class="navbar-nav" style="margin-left:1%">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="${pageContext.request.contextPath}/list?sort1=k&sort2=sho">신발</a>
                  <a class="dropdown-item" href="${pageContext.request.contextPath}/list?sort1=k&sort2=clo">의류</a>
                  <a class="dropdown-item" href="${pageContext.request.contextPath}/list?sort1=k&sort2=acc">용품</a>
                </div>
              </li>
            </ul>
