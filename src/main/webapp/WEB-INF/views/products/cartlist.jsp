                      ...
                      <td class="align-middle text-center">
                        <div class="d-inline-block">
                          <input type="number" class="form-control text-center" id="quantity" name="quantity" min="1"
                            value="${cartItem.quantity}" style="width: 70px;" oninput="handleValueChange(this)"">
                        </div>
                      </td>
...
<c:set var="ordersum" value="${sum+2500}" />
    ...
    <script>
      ...
      function handleValueChange(inputElement) {
        const currentValue = parseInt(inputElement.value);
        alert(currentValue);
        const previousValue = parseInt(inputElement.dataset.previousValue || 0);
        alert(previousValue);
      ...
      // Example functions to handle value changes
      function increaseValueFunction() {
        console.log("Value increased");
        // Perform your desired actions for value increase
      }

      function decreaseValueFunction() {
        console.log("Value decreased");
        // Perform your desired actions for value decrease
      }
    </script>
